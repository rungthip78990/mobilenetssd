...
lineaccesstoken = '4VRHUsXIeBCvBkERk07ARL9jVztiHBExS24zm9e7LP4+yZn7ekGU+qWtdoDnex8BFKQ9JMJbojlEY9WsduQrIK3zYGGUO7OUL1CYSZC0Cy3T3rlEYefg3ocNDugLHjD9aqQWJpDkMhNNMzxEj6LwvgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี"): 
            replyObj = TextSendMessage(text="ดีจ้าสุดสวย")
        elif (msg == "กินอะไรยาง"): 
            replyObj = TextSendMessage(text="ยังเลอ หิวจังง่ะ")
        elif (msg == "ทำไรอยู่"): 
            replyObj = TextSendMessage(text="หายใจ")
        else :
